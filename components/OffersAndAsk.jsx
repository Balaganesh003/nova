          ...
          <div className="bg-white w-[512px] lg:h-[300px] h-[280px] absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 rounded-lg py-6 px-8">
            ...
            <div className="lg:mb-7 mb-5">
              ...
              <textarea
                ...
                className="mt-1 h-[80px] resize-none outline-none  rounded-lg placeholder:text-gray-500 text-gray-500 w-full border text-xs lg:text-base focus:ring-0 focus:border-black "
              />
            </div>
