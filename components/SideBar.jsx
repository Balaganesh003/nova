...
const SideBar = () => {
  return (
    <div className="">
      {/* On Not Hover */}
      <div className="w-16 bg-white shadow-xl shadow-gray-300 h-[calc(100vh-3.5rem)] divide-y-[1px] flex flex-col overflow-y-scroll scrollbar-hide  px-2">
      ...
      {/* On Hover */}
      <div className="absolute top-0 h-screen w-[calc(100vw-1.1rem)] ">
        {/* Background effect */}
        <div className=" overflow-hidden h-screen z-0 bg-black bg-opacity-20"></div>
        {/* sideBar */}
        <div className="bg-white w-64 z-50 absolute top-0 h-screen overflow-y-scroll scrollbar-thin scrollbar-thumb-gray-400 scrollbar-track-white ">
